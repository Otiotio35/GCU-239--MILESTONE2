...
/**
 * The ShoppingCart class represents a shopping cart in a store front application.
 */
public class ShoppingCart {
     ...
     * If the product is already in the cart, the quantity is updated accordingly.
     *
    ...
    /**
     * Adds a salable product with the specified quantity to the shopping cart.
     * If the product is already in the cart, the quantity is updated accordingly.
     *
     * @param product  The Salable product to be added to the cart.
    ...
    /**
     * Returns the total cost of all the goods in the shopping cart after being calculated.
     *
     ...
     * For simplicity, this method just prints a message indicating that the checkout is completed.
     */
